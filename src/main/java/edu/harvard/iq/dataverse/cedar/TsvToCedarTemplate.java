...
public class TsvToCedarTemplate implements java.io.Serializable {
    ...
    private static void setupCedarTemplateParts() {
        ...
        String cedarTemplatePath = "cedar/cedarSchemaTemplate.json";
        String cedarTemplateFieldPath = "cedar/cedarTemplateField.json";
        String cedarStaticTemplateFieldPath = "cedar/cedarStaticTemplateField.json";
        String cedarTemplateElementPath = "cedar/cedarTemplateElement.json";
        ...
        if (cedarTemplateInputStream == null) {
            logger.log(Level.SEVERE, "CedarServiceBean was unable to process " + cedarTemplatePath);
        } else {
        ...
        if (cedarTemplateFieldInputStream == null) {
            logger.log(Level.SEVERE, "CedarServiceBean was unable to process " + cedarTemplateFieldPath);
        } else {
        ...
        if (cedarStaticTemplateFieldInputStream == null) {
            logger.log(Level.SEVERE, "CedarServiceBean was unable to process " + cedarStaticTemplateFieldPath);
        } else {
        ...
        if (cedarTemplateElementInputStream == null) {
            logger.log(Level.SEVERE, "CedarServiceBean was unable to process " + cedarTemplateElementPath);
        } else {
    ...
    private void processCommonFields(JsonObject templateElement, DataverseDatasetField datasetField, DataverseMetadataBlock dataverseMetadataBlock, boolean setIdentifier) {
        ...
        if (!templateElement.has("@id")) {
            templateElement.addProperty("@id", CedarServiceBean.generateNamedUuid(dataverseMetadataBlock.getName() + "-" + datasetField.getName()));
        }
        ...
        if (value != null) {
            ...
            if (cedarTemplate.has("_ext")) {
                ...
                if (_extPart.has("dataverse")) {
                    var dvPart = _extPart.getAsJsonObject("dataverse");
    ...
    private static InputStream getCedarTemplateFromResources(String fileName) {
        ...
        try (InputStream input = TsvToCedarTemplate.class.getClassLoader().getResourceAsStream(fileName)) {
            if (input == null) {
                logger.log(Level.SEVERE, "CedarServiceBean was unable to load " + fileName);
            }
            return input;
