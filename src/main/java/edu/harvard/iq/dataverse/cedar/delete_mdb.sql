...
BEGIN
    ...
    -- Delete from datasetfieldtypecedar and datasetfieldtypeoverride which depend on datasetfieldtype
    DELETE FROM public.datasetfieldtypecedar WHERE fieldtype_id IN
                                                 (SELECT id FROM public.datasetfieldtype WHERE metadatablock_id = p_metadatablock_id);
    ...
    -- Delete from metadatablockcedar and dataverse_metadatablock which depend on metadatablock
    DELETE FROM public.metadatablockcedar WHERE metadatablock_id = p_metadatablock_id;
